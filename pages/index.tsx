...
const Home: NextPage = () => {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-300 py-2">
      <Head>
        <title>DApp change state</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="flex w-full flex-1 flex-col items-center justify-center  px-20 text-center">
        <section className="body-font rounded-lg bg-gray-900 text-gray-400">
          <div className="container mx-auto flex flex-wrap items-center px-5 py-24">
            <div className="mx-auto pr-0 md:w-1/2 md:pr-16 lg:w-3/5 lg:pr-0">
